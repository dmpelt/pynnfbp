...
import nnfbp
from nnfbp.SimplePyCUDAProjector import SimplePyCUDAProjector
import numpy as np

# Create the PyCUDA projector
p = SimplePyCUDAProjector(256,np.linspace(0,np.pi,64,False))
...
network.saveToDisk('exampleNetworkPyCUDA.h5')
...
# without retraining.
networkLoaded = nnfbp.readFromDisk('exampleNetworkPyCUDA.h5',p)
